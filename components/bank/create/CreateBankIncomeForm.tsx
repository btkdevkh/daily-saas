...
import { createBankIncome } from "@/actions/post/bank";
import { IBankAccount } from "@/types/interfaces/IBankAccount";
import { useModalContext } from "@/context/ModalContext";

const CreateBankIncomeForm = ({
  bankAccount,
}: {
  ...
  const [state, formAction, isPending] = useActionState(createBankIncome, {
    success: false,
    message: "",
  });
...
export default CreateBankIncomeForm;

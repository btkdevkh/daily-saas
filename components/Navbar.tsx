...
const Navbar = ({ open }: NavbarProps) => {
  ...
  return (
    <>
      <nav className="py-1.5 px-3 bg-white">
        <div className="flex items-center gap-1 justify-between">
          ...
          <div className="flex gap-1 items-center">
            ...
            <div className="text-white font-semibold bg-light-teal w-[35px] h-[35px] rounded-full flex items-center justify-center shadow">
              <span>
      ...
      {/* Scroll indicator */}
      <div className="w-0 h-1 bg-light-teal" id="scroll-indicator"></div>
    </>
  );
};
